...
const ZEVA_AI_KB = [
  {
    ...
    answer: "Installing Zeva AI is as simple as pasting a 1-line JavaScript snippet (`<script src=\"https://cdn.zeva.app/widget.js\" data-bot-id=\"YOUR_BOT_ID\"></script>`) right before the `</body>` tag of your website HTML.",
    file: "widget_installation.pdf",
    match: 98,
    snip: "Installation Guide — Copy your 1-line embed script from Zeva Studio and paste it right before the closing </body> tag on your website.",
    hi: "Copy your 1-line embed script from Zeva Studio and paste it right before the closing </body> tag",
  },
  {
    keys: ["zeva", "what is zeva", "about zeva", "platform", "who are you"],
    answer: "Zeva AI is an intelligent RAG-powered chatbot platform that grounds every answer strictly in your company's official documents, eliminating AI hallucinations and capturing leads 24/7.",
    file: "zeva_overview.pdf",
    match: 97,
    snip: "Zeva AI Platform — Autonomous AI chatbot grounded in real business documents. Prevents hallucinations and captures qualified leads.",
    hi: "Autonomous AI chatbot grounded in real business documents.",
  },
  {
    keys: ["price", "pricing", "plan", "cost", "free", "tier", "subscription"],
    answer: "Zeva AI offers flexible plans: Starter ($29/mo), Pro ($79/mo with full white-labeling & Google Sheets sync), and custom Enterprise plans.",
    file: "zeva_pricing.pdf",
    match: 95,
    snip: "Zeva AI Plans & Pricing — Starter $29/mo, Pro $79/mo with white-labeling and unlimited chats, Enterprise custom SLA.",
