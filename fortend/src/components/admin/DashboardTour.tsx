...
function runTour(
  ...
  const steps: any[] = [
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          "Upload your docs, FAQs and prices. Your agent answers only from these — never made-up.",
        side: "right",
        align: "start",
      },
    },
    {
      ...
      popover: {
        title: "Make it yours",
        description:
          "Open Studio to set your agent's colour, welcome message and suggested questions — with a live preview.",
        side: "right",
        align: "start",
      },
    },
  ...
  const d = driver({
    ...
    overlayColor: "#0b1020",
    overlayOpacity: 0.6,
    popoverClass: "ochreshift-tour", // themed in globals.css
    nextBtnText: "Next",
    prevBtnText: "Back",
    doneBtnText: "Got it",
    steps,
