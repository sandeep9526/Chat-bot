    ...
    >
      ...
      {activeBot?.suspended && (
        <div className="mb-6 flex items-center justify-between rounded-r2 border border-red-500/40 bg-red-500/10 px-5 py-4 text-red-600 dark:text-red-400 shadow-sm">
          ...
          <a
            href={`mailto:support@zeva-ai.com?subject=Bot%20Suspension%20Inquiry%20-%20${activeBot.bot_id}`}
 ...
 * Zeva AI - Real-Time Lead Capture Sync
...
function doPost(e) {
  ...
  return (
    <>
      <SectionHeader title="Settings" description="Your bot's identity, appearance, integrations, and account security." />
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          ...
          <p className="mt-1 text-[12.5px] text-muted">
            Select the primary Large Language Model engine powering your bot's conversational intelligence and RAG answers.
          </p>
          <div className="mt-4 max-w-md">
            ...
            >
              <option value="">⚡ Automatic (Zeva Intelligent Multi-Model Failover Chain - Default)</option>
        ...
        <Card>
          ...
          <p className="mt-1 text-[12.5px] text-muted leading-relaxed">
            Define personality rules, formatting preferences, or strict guardrail constraints for your Zeva bot (e.g., <i>&quot;Never mention competitor pricing&quot;</i>, <i>&quot;Always ask if the user prefers a live phone call&quot;</i>). These guidelines are securely applied alongside verified RAG context.
          </p>
          ...
          {showDeleteModal && (
            <div className="mt-4 rounded-r1 border border-red-500/40 bg-red-500/5 p-4 text-[13px]">
              ...
              <p className="mt-1 mb-3 text-[12.5px] text-muted">
                Permanently deletes your user account, subscription tier, and all associated bots and leads. This operation is irreversible under GDPR data purge policies.
              </p>
              <div>
        ...
        <Card>
          ...
          <p className="mt-0.5 mb-3 text-[12.5px] text-muted">
            Execute Article 17 "Right to be Forgotten" requests. Enter a customer&apos;s email address, phone number, or exact name to permanently scrub their leads and chat conversation traces across your Zeva bots.
          </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-[2px]">
          <div className="max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-r2 border border-border bg-panel p-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-border pb-3">
              <h3 className="text-[16px] font-[750] text-fg">📊 Zeva Real-Time Google Sheets Lead Sync Setup</h3>
              <button
                type="button"
            ...
            <div className="mt-4 space-y-4 text-[13px] text-fg">
              <div className="rounded-r1 bg-canvas p-3.5 border border-border">
                ...
                <ol className="mt-2.5 ml-5 list-decimal space-y-1.5 text-[12.5px] text-muted leading-relaxed">
                  ...
                  <li>Delete any default code in the editor and <b>paste the automated Zeva Lead Sync template</b> provided below.</li>
