...
import { Hand, User, Circle } from "lucide-react";
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full relative max-w-5xl mx-auto">
            <Reveal delay={200} className="w-full">
               <div className="bg-surface rounded-2xl border border-border shadow-card-hover overflow-hidden w-full lg:min-h-[500px] flex flex-col md:flex-row relative">
                  ...
                  <div className="w-full md:w-[320px] border-b md:border-b-0 md:border-r border-border bg-bg/80 backdrop-blur-sm flex flex-col z-10 shrink-0">
                    <div className="p-5 border-b border-border flex items-center justify-between">
                      <span className="text-[12px] font-[700] text-faint uppercase tracking-widest">
                        Live Inbox
                      </span>
                    ...
                    <div className="p-3 flex flex-col gap-2">
                      {/* Active Lead Alert */}
                      <div className="bg-accent/10 border border-accent/25 rounded-lg p-4 flex flex-col gap-3 cursor-pointer shadow-lg relative overflow-hidden">
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-accent" />
                        <div className="flex items-center justify-between">
                          <span className="text-[15px] font-[600] text-fg">Priya Sharma</span>
                        ...
                        <div className="flex flex-col gap-1">
                          <span className="text-[12px] font-semibold text-muted">priya@example.com</span>
                          <span className="text-[12px] font-semibold text-muted">+1 555-0147</span>
                        </div>
                        <span className="text-[11px] text-accent font-medium">Wait time: 2m • Requested human</span>
                      </div>
                      ...
                      <div className="rounded-lg p-4 flex flex-col gap-2 opacity-50 border border-transparent hover:border-border transition-colors cursor-pointer">
                        ...
                        <span className="text-[12px] text-faint">Browsing pricing</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full flex-1 flex flex-col bg-surface/90 backdrop-blur-md z-10">
                    ...
                    <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-border flex items-center justify-between bg-panel">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="text-[16px] font-[600] text-fg">Priya Sharma</span>
                    ...
                    <div className="flex-1 p-4 sm:p-6 flex flex-col gap-4 sm:gap-5 overflow-y-auto min-h-[250px] sm:min-h-[300px]">
                      ...
                      <div className="flex gap-4 justify-end">
                         <div className="bg-accent text-[#08111F] text-[15px] px-5 py-4 rounded-2xl rounded-tr-sm w-fit max-w-[80%] text-right shadow-sm flex items-center gap-2">
                           <span className="font-bold text-[#08111F]/70 text-[11px] uppercase tracking-widest block">You</span>
                           Typing...
                         </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 sm:p-5 bg-bg border-t border-border">
                      <button className="w-full bg-fg text-bg font-[700] text-[15px] sm:text-[16px] py-3 sm:py-4 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
