  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-bg">
      ...
      {step === "appearance" ? (
        <div className="flex-1 flex flex-col bg-bg overflow-hidden relative">
          <div className="flex-1 overflow-y-auto w-full max-w-[1400px] mx-auto pt-0 px-6">
            <Studio botId={botId || ""} hideBanner={true} />
          </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex w-full flex-col overflow-y-auto md:w-[480px] lg:w-[540px] shrink-0 p-6 md:p-10 relative z-10">
          ...
          <div className="bg-surface rounded-[24px] shadow-sm border border-border/60 p-8 flex flex-col flex-1">
            ...
            {step !== "intro" && (
              <div className="flex items-center justify-between mt-auto pt-8 border-t border-border/50">
                <button
                  type="button"
                  onClick={() => step === "profile" ? setStep("intro") : step === "knowledge" ? setStep("profile") : setStep("knowledge")}
                  disabled={isProcessing}
                ...
                <button
                  type="button"
                  onClick={step === "profile" ? handleCreateBot : step === "knowledge" ? handleGoToAppearance : handleComplete}
        ...
        <div className="hidden flex-1 md:flex flex-col items-center justify-start pt-10 p-10 relative overflow-hidden bg-transparent">
          ...
          {step !== "intro" && (
            <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden bg-bg">
              <iframe src={websiteUrl || "https://www.ochreshift.in"} className="w-full h-full border-none pointer-events-none opacity-80" />
          ...
          {step === "intro" ? (
            ...
            <div className="absolute bottom-6 right-6 z-10 animate-fade-in-up w-[380px] h-full max-h-[550px]">
              <TestChatBox
                botId={botId || "preview"}
                botName={name}
