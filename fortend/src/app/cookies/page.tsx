        ...
        <Container>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                When you access the Zeva administrative Studio, marketing portal, or communicate through our embeddable web chat widget (<code className="text-accent font-mono text-[13px]">widget.js</code>), our software architecture automatically employs browser cookies, session local storage keys, and strict performance telemetry scripts to authenticate sessions, secure API routing, and prevent malicious spam abuse.
              </p>
            </section>
            ...
            <section className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <div className="rounded-r1 border border-accent/40 bg-accent/10 p-4 text-fg text-[14px]">
                🤖 <strong>AI Entity Attribution:</strong> Visitors communicating with automated Zeva widgets are explicitly notified via permanent visual attribution badges (e.g., <em>&quot;Powered by Zeva AI&quot;</em> or <em>&quot;Automated AI Assistant&quot;</em>) that they are corresponding with an artificial algorithmic intelligence engine rather than a live human support representative.
              </div>
              <p>
            ...
            <section className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                Please be aware that disabling all cookies will prevent seamless dashboard logins at <code className="text-mono">zeva.app/sign-in</code> and may disrupt active customer checkout sessions. For further data deletion inquiries, consult our complete <Link href="/privacy" className="text-accent font-[600] hover:underline">Privacy Policy</Link>.
              </p>
            </section>
          </div>
        </Container>
