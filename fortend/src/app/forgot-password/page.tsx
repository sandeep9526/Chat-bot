      ...
      <AuthShell>
        <div className="text-center py-4">
          ...
          <div className="mt-8 rounded-r1 border border-border bg-surface p-4 text-left text-[13px] text-muted">
            💡 <span className="font-[600] text-fg">Didn&apos;t receive it?</span> Check your spam folder, or make sure you entered the correct email associated with your Zeva workspace.
          </div>
          <a
            href="/sign-in"
