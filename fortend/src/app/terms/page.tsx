        ...
        <Container>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                By creating an account, embedding the Zeva conversational widget, or upgrading to a paid subscription, you enter into a legally binding agreement with Zeva AI Ltd. ("Zeva", "we", or "our"). These Terms govern your usage of our multi-model generative artificial intelligence chatbots, real-time Helpdesk takeover dashboards, and customer data synchronization pipelines.
              </p>
            </section>
            ...
            <section id="aup" className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                To maintain high-reliability network architectures and prevent abuse, subscribers strictly agree not to deploy Zeva for:
              </p>
            ...
            <section id="exemption" className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                Zeva automated conversational engines are engineered for commercial customer support, general service FAQ resolution, and appointment onboarding. Subscribers explicitly acknowledge and agree to strict high-risk operational domain exclusions:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-fg">Medical Diagnosis & Triage:</strong> Zeva cannot be deployed as an autonomous clinical healthcare counselor, diagnostic device, or emergency medical dispatch engine.</li>
                <li><strong className="text-fg">Legal & Regulatory Representation:</strong> Responses generated by Zeva chatbots do not constitute formal legal representation, statutory defense, or attorney-client privileged interaction.</li>
            ...
            <section className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                While Zeva incorporates grounded Retrieval-Augmented Generation (RAG) algorithms, multi-model failover chains, and adversarial guardrails, large language models natively possess statistical variance that can result in inaccurate outputs ("hallucinations").
              </p>
              <p>
                To the maximum extent permitted by governing corporate law, Zeva disclaims liability for commercial losses, missed customer appointments, contractual inaccuracies, or revenue variance resulting from automated chatbot responses. Subscribers assume primary obligation for reviewing chat analytics and configuring fallback live human intervention thresholds.
              </p>
            </section>
