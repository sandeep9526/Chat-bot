          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>Navigate to your admin dashboard at <Link href="/studio" className="text-accent font-[600] hover:underline">ochreshift.com/studio</Link>.</li>
                <li>Select your Agent or tenant workspace and access the <strong className="text-fg">Billing &amp; Plan Upgrade</strong> section.</li>
