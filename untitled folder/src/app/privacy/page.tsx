        ...
        <Container>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section id="dpa" className="space-y-4 text-[14.5px] leading-relaxed text-muted border-t border-border pt-8">
              ...
              <p>
                For B2B Enterprise subscribers operating in regulated industries, ochreshift acts as a dedicated <strong className="text-fg">Data Processor</strong>, while the subscribing merchant or business enterprise retains exclusive ownership as the governing <strong className="text-fg">Data Controller</strong>. Our platform Standard Contractual Clauses (SCCs) are embedded by reference within every commercial subscription agreement.
              </p>
              <p>
                To request a signed copy of our formal institutional Data Processing Addendum (DPA), please contact our legal compliance team at <a href="mailto:legal@ochreshift.com" className="text-accent font-[600] hover:underline">legal@ochreshift.com</a>.
              </p>
            </section>
          </div>
        </Container>
