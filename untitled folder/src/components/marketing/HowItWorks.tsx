...
const STEPS: Step[] = [
  {
    ...
    body: "Drop your website URL, FAQs, price list and docs. ochreshift ingests and indexes everything in minutes.",
  },
  {
    icon: PaletteIcon,
    title: "Make it yours",
  ...
  },
  {
    ...
    body: "ochreshift answers 24/7 with sources and captures name + phone. Every lead lands in your dashboard.",
  },
];
