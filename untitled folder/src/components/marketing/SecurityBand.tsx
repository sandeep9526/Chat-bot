...
const PROMISES: Guarantee[] = [
  {
    ...
    body: "ochreshift answers only from the documents you give it. If the answer isn't there, it says so — it never invents hours, prices or promises.",
  },
  {
  ...
  {
    icon: LockIcon,
    title: "Your content, your agent",
    body: "Your documents power only your agent. Every business gets its own isolated knowledge base — never mixed with anyone else's.",
  },
  {
    icon: SlidersIcon,
        ...
        <SectionHead
          ...
          description={
            <>
              ...
              every owner asks. ochreshift is built so the answer is no — by design,
              not by hope.
            </>
          }
        />
