    ...
    return (
      <div className="rounded-r2 border border-border bg-surface p-4 shadow-card">
        ...
        <p className="mt-1 text-[13px] text-muted">
          No plan yet — create your first agent to start a 14-day trial automatically.
        </p>
      </div>
    );
  }
    ...
    <div className="rounded-r2 border border-border bg-surface p-4 shadow-panel">
      ...
      <div className="mt-4 border-t border-border pt-3.5">
        ...
        <p className="mt-4 border-t border-border pt-3 text-[11.5px] text-faint leading-normal">
          By activating a subscription plan or recurring billing mandate, you acknowledge and agree to ochreshift&apos;s{" "}
